...
export const metadata: Metadata = {
  title: 'Hot Water Recirculation Pump Specialists Nationwide | United Plumbing CCTX',
  description: 'End cold water delays—United Plumbing CCTX installs and repairs recirculation pumps, balancing loops and smart timers for homes and businesses across the United States.',
  keywords: [
  ...
  openGraph: {
    title: 'Hot Water Recirculation Pump Specialists Nationwide | United Plumbing CCTX',
    description: 'End cold water delays—United Plumbing CCTX installs and repairs recirculation pumps, balancing loops and smart timers for homes and businesses across the United States.',
    url: 'https://unitedplumbingcctx.com/services/plumber-water-recirculation-pump',
  ...
  alternates: {
    canonical: 'https://unitedplumbingcctx.com/services/plumber-water-recirculation-pump',
  },
};
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Look no further! United Plumbing CCTX is your trusted plumbing expert. We provide comprehensive water recirculation pump solutions for both residential and commercial properties, with 24/7 emergency service availability.
              </p>
